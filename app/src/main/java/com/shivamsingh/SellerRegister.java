...
import com.shivamsingh.model.Products;
import com.shivamsingh.netclan.R;
import com.shivamsingh.netclan.databinding.ActivitySellerRegisterBinding;
...
public class SellerRegister extends AppCompatActivity {
    ...
    // Define product-related variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up a listener for the discount switch
        ...
        // Handle the category selection click
        ...
        binding.btnaddproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (shippingFee.equals("Empty")) {
                    Toast.makeText(SellerRegister.this, "Please update your shipping fee from settings", Toast.LENGTH_SHORT).show();
                } else {
                    validateData();
                }
            }
    ...
    private void validateData() {
        ...
        if (discountAvailable) {
            ...
            if (TextUtils.isEmpty(discountPrice)) {
                binding.txtdiscountPrice.setError("Penalty Price Required");
                return;
            } else if (TextUtils.isEmpty(discount_desc)) {
                binding.txtdiscountDescription.setError("");
                return;
            }
        } else {
            discountPrice = "0";
            ...
            databaseReference.child(mAuth.getUid()).child("Products").child(timestamp)
                    .setValue(obj).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast toast = Toast.makeText(SellerRegister.this, "Product Added Successfully", Toast.LENGTH_SHORT);
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast toast = Toast.makeText(SellerRegister.this, e.getMessage(), Toast.LENGTH_SHORT);
